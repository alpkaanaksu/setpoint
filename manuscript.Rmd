...
![](material/setpoint_definitions_swb.drawio.png)
...
- We do not take anticipatory effects into account. SWB tends to change before major life events, if people know that something is going to happen. Before marriage as life event people can already anticipate their wedding, which leads to an increase in SWB.
- AWB and CWB are summarized into a single SWB construct.
- Life Event and Initial Reaction are reduced to Initial Reaction (appraisal of the situation), since only the latter is important for the following psychological processes.
